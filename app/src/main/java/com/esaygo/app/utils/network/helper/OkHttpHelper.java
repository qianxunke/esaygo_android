                    ...
                    public Response intercept(Chain chain) throws IOException {
                        if(UserModel.getCurrentUser()!=null) {
                            Request request = chain.request()
                                    .newBuilder()
                                    .addHeader("Authorization",UserModel.getCurrentUser().getToken())
                                    .build();
