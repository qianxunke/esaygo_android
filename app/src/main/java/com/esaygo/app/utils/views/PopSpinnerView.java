package com.esaygo.app.utils.views;
...
public class PopSpinnerView extends RelativeLayout {
    ...
    private final int SPACETOLEFTIMAGE = 10;  //文字距离左边图标像素距离

    /**
     * 自定义属性的参数 开始
     */
    public String textName; //未选择时提示的文字
    public int itemWidth;  //控件宽度
    ...
    public ImageView mIv_arrow, mIv_leftIcon;
    ...
    private void initPopWindow(View view, Context context) {
        if (listSize == 2) {
            ...
            height = listSize >= 8 ? 180 : listSize * 30;
        }
